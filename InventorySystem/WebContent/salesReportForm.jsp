...
<body>
	...
	<form method="post" onsubmit="return validate()" action="/SalesSystem/SalesReport">
		<table>
			<tr>
			...
			<tr>
				<td colspan="2" align="center">
					<input type="submit" name="reportType" value="By Category" />
					<input type="submit" name="reportType" value="By Customer" />
				</td>
			</tr>
		</table>
	</form>
